package DataBase.Facturacion.FacturaCompra.DetallePorPagar;
...
public class Insert {
    ...
    public static boolean detalleCompraPorPagar(String[] datos) {
        @SuppressWarnings("UnusedAssignment")
        PreparedStatement stm = null;
        try {
            stm = DataBase.ClientConexion.getConn().prepareStatement("insert into detallecompraporpagar"
            ...
            int ultimaFacturaId = DataBase.Facturacion.FacturaCompra.CompraPorPagar.Select.ultimoId();

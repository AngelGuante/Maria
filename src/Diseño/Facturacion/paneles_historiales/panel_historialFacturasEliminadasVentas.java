...
public class panel_historialFacturasEliminadasVentas extends Diseño.Facturacion.paneles_base.panelBase {
    ...
    public panel_historialFacturasEliminadasVentas() {
        initComponents();
        ComponentsDetails();
    }
        ...
        try (java.sql.ResultSet rs = DataBase.Facturacion.FacturaVenta.Detalle.Select
            ...
            while (rs.next()) {
                model2.addRow(new Object[]{
                    rs.getString("detalleventa.producto_idProducto"),
                    rs.getString("producto.descripcionProducto"),
                    rs.getString("detalleventa.costoProductoIndividualVenta"),
                    rs.getString("detalleventa.cantidadProductoVenta"),
                    rs.getInt("detalleventa.costoProductoIndividualVenta")
    ...
    private void EventoCampoBuscar() {
        Logica.tablas.Tabla_limpiarFilas.limpiarTabla(model1, tabla1);
        try (java.sql.ResultSet rs = DataBase.Facturacion.FacturaVenta.Venta.Select

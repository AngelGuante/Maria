...
public class Reporte_generarSinDB {

    /**
     * Genera un reporte que sus datos vengan de datos primitivos mandados desde
     * el mismo Java directamente sin Bases de datos.
     *
     * @param parametros
     * @param reporteNombre
     ...
     * reporte.
     */
    public static void ReportesSinDB(java.util.Map<String, Object> parametros, String reporteNombre, boolean imprimir) {
        //Datos del negocio
